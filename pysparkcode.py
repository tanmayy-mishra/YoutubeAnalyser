...
# Predicate pushdown to filter data
predicate_pushdown = "region in ('ca','gb','us')"

# Load data from AWS Glue Data Catalog
datasource0 = glueContext.create_dynamic_frame.from_catalog(
    database="ytdatanalysis_raw",
...
# Convert to DataFrame and coalesce
...
datasink4 = glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={
        "path": "s3://ytdatanalysis-cleansed-useast1-dev/youtube/raw_statistics/",
